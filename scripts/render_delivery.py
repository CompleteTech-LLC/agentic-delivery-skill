#!/usr/bin/env python3
"""List and render agentic development delivery artifacts."""
...
CATALOG_MD = ROOT / "references" / "delivery-catalog.md"
...
def extract_template(template_id: str) -> str:
    ...
    if not match:
        raise KeyError(f"Template not found in delivery-catalog.md: {template_id}")
...
def main() -> int:
    ...
    parser.add_argument("--list", action="store_true", help="List available delivery artifact IDs.")
